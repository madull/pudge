...
import com.pudge.entity.weixin.merchant.bean.ProductRequest.ProductStatus;
import com.pudge.entity.weixin.merchant.bean.ProductRequest.Response.Properties;
import com.pudge.entity.weixin.merchant.bean.ProductRequest.Response.SkuTable;
import com.pudge.entity.weixin.merchant.builder.ProductBuilder;
import com.pudge.exception.weixin.WeixinException;
import com.pudge.util.CommonUtils;
import com.pudge.util.DataBuilder.RequriedType;
...
public class MerchantProductService {
    ...
    public MerchantProductService(AbstractWeixinmpController controller) {

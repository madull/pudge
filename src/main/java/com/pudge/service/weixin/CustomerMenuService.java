...
import com.pudge.entity.weixin.base.CustomMenu;
import com.pudge.entity.weixin.base.CustomMenu.CustomButton;
...
public class CustomerMenuService {
    ...
    public CustomerMenuService(AbstractWeixinmpController controller) {

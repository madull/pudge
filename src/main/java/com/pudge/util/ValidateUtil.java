...
public class ValidateUtil {
	...
	/** 身份证  */
  	...
  	/**MAC地址*/
  	private static final String MAC_ADDRESS="^[A-Fa-f0-9]{2}(:[A-Fa-f0-9]{2}){5}$||^[A-Fa-f0-9]{2}(-[A-Fa-f0-9]{2}){5}$";
	...
	public static boolean MacAddress(String value){
		return match(MAC_ADDRESS,value);
	}

...
public class TextLineChineseDecoder  implements ProtocolDecoder {
	 ...
	 private final AttributeKey CONTEXT = new AttributeKey(getClass(), "context");
	     ...
	     */
	    public TextLineChineseDecoder(String delimiter) {
	     ...
	     * and the specified <tt>delimiter</tt>.
	     */
	    public TextLineChineseDecoder(LineDelimiter delimiter) {
	     ...
	     * and {@link LineDelimiter#AUTO} delimiter.
	     */
	    public TextLineChineseDecoder(Charset charset) {
	     ...
	     * and the specified <tt>delimiter</tt>.
	     */
	    public TextLineChineseDecoder(Charset charset, String delimiter) {
	     ...
	     * and the specified <tt>delimiter</tt>.
	     */
	    public TextLineChineseDecoder(Charset charset, LineDelimiter delimiter) {
	        if (charset == null) {
	            ...
	            if (matched) {
	                ...
	                if (ctx.getOverflowPosition() == 0) {
	                    ...
	                    try {
	                        ...
	                        // 解决中文乱码问题
	                        //String str = new String(buffer.array());   str >>buffer.toString()
	                        writeText(session, buffer.toString(), out);
	                    } finally {
	                        buf.clear();
	                    }
	                } else {
